...
void phy_debug_init(void) {
  ...
  NRF_GPIOTE->SUBSCRIBE_SET[PHY_GPIOTE_DEBUG_1] =
    DPPI_CH_SUB(TIMER0_EVENTS_COMPARE_0);
  NRF_GPIOTE->SUBSCRIBE_CLR[PHY_GPIOTE_DEBUG_1] =
    DPPI_CH_SUB(RADIO_EVENTS_READY);
#endif
  ...
  NRF_GPIOTE->SUBSCRIBE_SET[PHY_GPIOTE_DEBUG_2] =
    DPPI_CH_SUB(RADIO_EVENTS_ADDRESS);
  ...
  NRF_DPPIC->CHENSET =
    DPPI_CH_MASK(RADIO_EVENTS_RXREADY) | DPPI_CH_MASK(RADIO_EVENTS_DISABLED);

  NRF_GPIOTE->SUBSCRIBE_SET[PHY_GPIOTE_DEBUG_3] =
    DPPI_CH_SUB(RADIO_EVENTS_RXREADY);
   ...
   * PIN doesn't work...
   */
  NRF_GPIOTE->SUBSCRIBE_CLR[PHY_GPIOTE_DEBUG_3] =
    DPPI_CH_SUB(RADIO_EVENTS_DISABLED);
  NRF_GPIOTE->SUBSCRIBE_CLR[PHY_GPIOTE_DEBUG_3] =
    DPPI_CH_SUB(RADIO_EVENTS_ADDRESS);
  NRF_GPIOTE->SUBSCRIBE_CLR[PHY_GPIOTE_DEBUG_3] =
    DPPI_CH_SUB(TIMER0_EVENTS_COMPARE_3);
