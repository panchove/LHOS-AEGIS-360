#ifndef ASYNC_A7670_FIFO_H
#define ASYNC_A7670_FIFO_H

#include <Arduino.h>
#include <esp_heap_caps.h> // For heap_caps_malloc

#ifndef ASYNC_A7670_RX_BUFFER
#define ASYNC_A7670_RX_BUFFER 1460 // Default buffer size if not defined
#endif

template <class T, unsigned N> class AsyncA7670Fifo {
public:
  AsyncA7670Fifo() { clear(); }
