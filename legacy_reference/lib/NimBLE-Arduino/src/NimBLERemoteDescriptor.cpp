 ...
 * @param [in] pRemoteCharacteristic A pointer to the Characteristic that this
 * belongs to.
 * @param [in] dsc A pointer to the struct that contains the descriptor
 * information.
 */
NimBLERemoteDescriptor::NimBLERemoteDescriptor(
