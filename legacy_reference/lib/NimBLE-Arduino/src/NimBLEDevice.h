...
public:
...
#ifdef ESP_PLATFORM
#ifndef CONFIG_IDF_TARGET_ESP32P4
  static esp_power_level_t
  getPowerLevel(esp_ble_power_type_t powerType = ESP_BLE_PWR_TYPE_DEFAULT);
  static bool
  setPowerLevel(esp_power_level_t powerLevel,
  ...
  static bool startAdvertising(uint8_t instId, int duration = 0,
                               int maxEvents = 0);
