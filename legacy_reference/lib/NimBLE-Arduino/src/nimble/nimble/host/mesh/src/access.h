 ...
 *
 * Register a callback function to act as a hook for recieving mesh model layer
 * messages directly to the application without having instantiated the relevant
 * models.
 *
 ...
 *
 * Send a mesh model layer message out into the mesh network without having
 * instantiated the relevant mesh models.
 *
