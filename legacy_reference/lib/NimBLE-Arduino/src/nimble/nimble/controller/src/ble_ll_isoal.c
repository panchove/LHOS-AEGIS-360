...
static void ble_ll_isoal_mux_tx_pkt_in(struct ble_ll_isoal_mux *mux,
                                       struct os_mbuf *om, uint8_t pb,
                                       uint32_t timestamp) {
  struct os_mbuf_pkthdr *pkthdr;
...
int ble_ll_isoal_mux_unframed_get(struct ble_ll_isoal_mux *mux, uint8_t idx,
...
static void ble_ll_isoal_tx_pkt_in(struct ble_npl_event *ev) {
  struct os_mbuf *om;
  struct os_mbuf_pkthdr *pkthdr;
