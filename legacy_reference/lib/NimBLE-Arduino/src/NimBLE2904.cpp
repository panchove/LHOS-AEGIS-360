...
NimBLE2904::NimBLE2904(NimBLECharacteristic *pChr)
    : NimBLEDescriptor(NimBLEUUID((uint16_t)0x2904), BLE_GATT_CHR_F_READ,
                       sizeof(NimBLE2904Data), pChr) {
  setValue(m_data);
} // NimBLE2904
 ...
 * @param [in] unit The type of units of this characteristic as defined by
 * assigned numbers.
