...
#define NIMBLE_BLE_ATT_CLT_FIND_INFO (MYNEWT_VAL(BLE_GATT_DISC_ALL_DSCS))

#undef NIMBLE_BLE_ATT_CLT_FIND_TYPE
#define NIMBLE_BLE_ATT_CLT_FIND_TYPE (MYNEWT_VAL(BLE_GATT_DISC_SVC_UUID))

#undef NIMBLE_BLE_ATT_CLT_READ_TYPE
#define NIMBLE_BLE_ATT_CLT_READ_TYPE                                           \
  (MYNEWT_VAL(BLE_GATT_FIND_INC_SVCS) || MYNEWT_VAL(BLE_GATT_DISC_ALL_CHRS) || \
   MYNEWT_VAL(BLE_GATT_DISC_CHRS_UUID) || MYNEWT_VAL(BLE_GATT_READ_UUID))

#undef NIMBLE_BLE_ATT_CLT_READ
#define NIMBLE_BLE_ATT_CLT_READ                                                \
  (MYNEWT_VAL(BLE_GATT_READ) || MYNEWT_VAL(BLE_GATT_READ_LONG) ||              \
   MYNEWT_VAL(BLE_GATT_FIND_INC_SVCS))

#undef NIMBLE_BLE_ATT_CLT_READ_BLOB
#define NIMBLE_BLE_ATT_CLT_READ_BLOB (MYNEWT_VAL(BLE_GATT_READ_LONG))

#undef NIMBLE_BLE_ATT_CLT_READ_MULT
#define NIMBLE_BLE_ATT_CLT_READ_MULT (MYNEWT_VAL(BLE_GATT_READ_MULT))

#undef NIMBLE_BLE_ATT_CLT_READ_MULT_VAR
#define NIMBLE_BLE_ATT_CLT_READ_MULT_VAR (MYNEWT_VAL(BLE_GATT_READ_MULT_VAR))
...
#define NIMBLE_BLE_ATT_CLT_SIGNED_WRITE (MYNEWT_VAL(BLE_GATT_SIGNED_WRITE))

#undef NIMBLE_BLE_ATT_CLT_WRITE
#define NIMBLE_BLE_ATT_CLT_WRITE (MYNEWT_VAL(BLE_GATT_WRITE))

#undef NIMBLE_BLE_ATT_CLT_WRITE_NO_RSP
#define NIMBLE_BLE_ATT_CLT_WRITE_NO_RSP (MYNEWT_VAL(BLE_GATT_WRITE_NO_RSP))

#undef NIMBLE_BLE_ATT_CLT_PREP_WRITE
#define NIMBLE_BLE_ATT_CLT_PREP_WRITE (MYNEWT_VAL(BLE_GATT_WRITE_LONG))
...
#define NIMBLE_BLE_ATT_CLT_NOTIFY (MYNEWT_VAL(BLE_GATT_NOTIFY))

#undef NIMBLE_BLE_ATT_CLT_INDICATE
#define NIMBLE_BLE_ATT_CLT_INDICATE (MYNEWT_VAL(BLE_GATT_INDICATE))

#undef NIMBLE_BLE_ATT_CLT_NOTIFY_MULT
#define NIMBLE_BLE_ATT_CLT_NOTIFY_MULT (MYNEWT_VAL(BLE_GATT_NOTIFY_MULTIPLE))
