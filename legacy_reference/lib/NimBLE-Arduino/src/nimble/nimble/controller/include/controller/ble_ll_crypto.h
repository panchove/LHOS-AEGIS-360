...
int ble_ll_crypto_cmac(const uint8_t *key, const uint8_t *in, int len,
                       uint8_t *out);

static inline int ble_ll_crypto_h6(const uint8_t *w, const uint8_t *key_id,
                                   uint8_t *out) {
  return ble_ll_crypto_cmac(w, key_id, 4, out);
}

static inline int ble_ll_crypto_h7(const uint8_t *salt, const uint8_t *w,
                                   uint8_t *out) {
