...
static inline void ble_phy_trace_void(unsigned id) {
  os_trace_api_void(ble_phy_trace_off + id);
}

static inline void ble_phy_trace_u32(unsigned id, uint32_t p1) {
  os_trace_api_u32(ble_phy_trace_off + id, p1);
}

static inline void ble_phy_trace_u32x2(unsigned id, uint32_t p1, uint32_t p2) {
  os_trace_api_u32x2(ble_phy_trace_off + id, p1, p2);
}

static inline void ble_phy_trace_u32x3(unsigned id, uint32_t p1, uint32_t p2,
                                       uint32_t p3) {
...
static inline void ble_phy_trace_init(void) {}
