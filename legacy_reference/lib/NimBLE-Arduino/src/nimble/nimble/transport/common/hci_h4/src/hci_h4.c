...
static void hci_h4_frame_start(struct hci_h4_sm *rxs, uint8_t pkt_type) {
...
static int hci_h4_ib_consume(struct hci_h4_input_buffer *ib, uint16_t len) {
  assert(ib->len >= len);
...
static int hci_h4_ib_pull_min_len(struct hci_h4_sm *rxs,
...
static int hci_h4_sm_w4_header(struct hci_h4_sm *h4sm,
                               struct hci_h4_input_buffer *ib) {
  int rc;
...
static int hci_h4_sm_w4_payload(struct hci_h4_sm *h4sm,
                                struct hci_h4_input_buffer *ib) {
  uint16_t mbuf_len;
  uint16_t len;
  int rc;
...
static void hci_h4_sm_completed(struct hci_h4_sm *h4sm) {
  int rc;
