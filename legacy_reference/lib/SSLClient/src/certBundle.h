 ...
 * esp_crt_bundle_set() it will default to the bundle defined in menuconfig and
 ...
 *
 * Overrides the default certificate bundle. In most use cases the bundle should
 * be set through menuconfig. The bundle needs to be sorted by subject name
 * since binary search is used to find certificates.
 *
