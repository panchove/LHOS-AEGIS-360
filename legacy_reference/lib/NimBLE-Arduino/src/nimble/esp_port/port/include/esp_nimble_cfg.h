...
#else
#define MYNEWT_VAL_BLE_MAX_PERIODIC_ADVERTISER_LIST                            \
...
#define MYNEWT_VAL_BLE_GATT_CACHING_MAX_CONNS                                  \
...
#define MYNEWT_VAL_BLE_GATT_CACHING_MAX_DSCS                                   \
...
#define MYNEWT_VAL_BLE_GATT_CACHING_DISABLE_AUTO                               \
...
#else
#define MYNEWT_VAL_BLE_LL_CFG_FEAT_LE_2M_PHY                                   \
...
#else
#define MYNEWT_VAL_BLE_LL_CFG_FEAT_LE_CODED_PHY                                \
...
/* Overridden by @apache-mynewt-nimble/nimble/controller (defined by
 * @apache-mynewt-nimble/nimble/controller) */
...
#define MYNEWT_VAL_BLE_LL_CFG_FEAT_LE_PING                                     \
...
#define MYNEWT_VAL_BLE_LL_CFG_FEAT_LL_PERIODIC_ADV                             \
...
#define MYNEWT_VAL_BLE_LL_CFG_FEAT_LL_PERIODIC_ADV_SYNC_CNT                    \
  (MYNEWT_VAL_BLE_MAX_PERIODIC_SYNCS)
#endif

#define MYNEWT_VAL_BLE_LL_CFG_FEAT_LL_PERIODIC_ADV_SYNC_LIST_CNT               \
  (MYNEWT_VAL_BLE_MAX_PERIODIC_SYNCS)

#ifndef CONFIG_BT_NIMBLE_PERIODIC_ADV_SYNC_TRANSFER
#define MYNEWT_VAL_BLE_PERIODIC_ADV_SYNC_TRANSFER (0)
#else
#define MYNEWT_VAL_BLE_PERIODIC_ADV_SYNC_TRANSFER                              \
  (CONFIG_BT_NIMBLE_PERIODIC_ADV_SYNC_TRANSFER)
#endif

/* Value copied from BLE_PERIODIC_ADV_SYNC_TRANSFER */
#define MYNEWT_VAL_BLE_LL_CFG_FEAT_LL_PERIODIC_ADV_SYNC_TRANSFER               \
  (CONFIG_BT_NIMBLE_PERIODIC_ADV_SYNC_TRANSFER)
...
#define MYNEWT_VAL_BLE_PUBLIC_DEV_ADDR                                         \
  (((uint8_t[6]){0x01, 0x21, 0x03, 0x66, 0x05, 0x30}))
#endif
...
#define MYNEWT_VAL_BLE_GATT_BLOB_TRANSFER                                      \
...
#define MYNEWT_VAL_BLE_HS_STOP_ON_SHUTDOWN_TIMEOUT                             \
...
#define MYNEWT_VAL_BLE_SVC_BAS_BATTERY_LEVEL_NOTIFY_ENABLE                     \
...
#define MYNEWT_VAL_BLE_SVC_HID_MAX_SVC_INSTANCES                               \
...
/* Overridden by apps/blemesh (defined by
 * @apache-mynewt-nimble/nimble/host/mesh) */
...
#define MYNEWT_VAL_BLE_SVC_GAP_DEVICE_NAME_MAX_LENGTH                          \
  CONFIG_BT_NIMBLE_GAP_DEVICE_NAME_MAX_LEN // According to the specification,
                                           // the maximum length should be 248
#endif
...
#define MYNEWT_VAL_BLE_ENABLE_CONN_REATTEMPT                                   \
...
#define MYNEWT_VAL_BLE_HOST_ALLOW_CONNECT_WITH_SCAN                            \
...
#define MYNEWT_VAL_BLE_TRANSPORT_UART_PARITY__none                             \
  CONFIG_BT_NIMBLE_TRANSPORT_UART_PARITY_NONE
#endif

#ifndef MYNEWT_VAL_BLE_TRANSPORT_UART_PARITY__odd
#define MYNEWT_VAL_BLE_TRANSPORT_UART_PARITY__odd                              \
  CONFIG_BT_NIMBLE_TRANSPORT_UART_PARITY_ODD
#endif

#ifndef MYNEWT_VAL_BLE_TRANSPORT_UART_PARITY__even
#define MYNEWT_VAL_BLE_TRANSPORT_UART_PARITY__even                             \
  CONFIG_BT_NIMBLE_TRANSPORT_UART_PARITY_EVEN
#endif

#ifndef MYNEWT_VAL_BLE_TRANSPORT_UART_FLOW_CONTROL__rtscts
#define MYNEWT_VAL_BLE_TRANSPORT_UART_FLOW_CONTROL__rtscts                     \
  CONFIG_BT_NIMBLE_HCI_UART_FLOW_CTRL
#endif

#ifndef MYNEWT_VAL_BLE_TRANSPORT_UART_BAUDRATE
#define MYNEWT_VAL_BLE_TRANSPORT_UART_BAUDRATE                                 \
  CONFIG_BT_NIMBLE_HCI_UART_BAUDRATE
#endif
...
#define MYNEWT_VAL_BLE_PERIODIC_ADV_WITH_RESPONSES                             \
