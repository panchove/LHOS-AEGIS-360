...
static inline int ble_ll_conn_rem_feature_check(struct ble_ll_conn_sm *connsm,
                                                uint64_t feature) {
  uint8_t byte_idx;
...
static inline void ble_ll_conn_rem_feature_add(struct ble_ll_conn_sm *connsm,
                                               uint64_t feature) {
  uint8_t byte_idx;
