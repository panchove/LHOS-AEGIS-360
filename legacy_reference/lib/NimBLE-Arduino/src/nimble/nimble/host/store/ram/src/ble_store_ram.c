...
ble_store_ram_delete_cccd(const struct ble_store_key_cccd *key_cccd) {
  ...
  rc =
    ble_store_ram_delete_obj(ble_store_ram_cccds, sizeof *ble_store_ram_cccds,
...
#if MYNEWT_VAL(BLE_STORE_MAX_CSFCS)
static int ble_store_ram_find_csfc(const struct ble_store_key_csfc *key) {
...
ble_store_ram_delete_csfc(const struct ble_store_key_csfc *key_csfc) {
  ...
  rc =
    ble_store_ram_delete_obj(ble_store_ram_csfcs, sizeof *ble_store_ram_csfcs,
...
static int ble_store_ram_read_csfc(const struct ble_store_key_csfc *key_csfc,
...
static int ble_store_ram_delete_ead(const struct ble_store_key_ead *key_ead) {
  int idx;
  int rc;
  ...
  rc = ble_store_ram_delete_obj(ble_store_ram_eads, sizeof *ble_store_ram_eads,
...
static int ble_store_ram_read_ead(const struct ble_store_key_ead *key_ead,
