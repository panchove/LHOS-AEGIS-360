...
static inline void ble_npl_eventq_put(struct ble_npl_eventq *evq,
                                      struct ble_npl_event *ev) {
  return npl_funcs->p_ble_npl_eventq_put(evq, ev);
}

static inline void ble_npl_eventq_remove(struct ble_npl_eventq *evq,
                                         struct ble_npl_event *ev) {
...
static inline void ble_npl_event_init(struct ble_npl_event *ev,
...
static inline ble_npl_error_t ble_npl_mutex_pend(struct ble_npl_mutex *mu,
...
static inline ble_npl_error_t ble_npl_sem_init(struct ble_npl_sem *sem,
                                               uint16_t tokens) {
...
static inline ble_npl_error_t ble_npl_sem_pend(struct ble_npl_sem *sem,
                                               ble_npl_time_t timeout) {
...
static inline int ble_npl_callout_init(struct ble_npl_callout *co,
...
static inline ble_npl_error_t ble_npl_time_ticks_to_ms(ble_npl_time_t ticks,
                                                       uint32_t *out_ms) {
...
static inline void ble_npl_hw_set_isr(int irqn, uint32_t addr) {
...
static inline void ble_npl_event_deinit(struct ble_npl_event *ev) {}
