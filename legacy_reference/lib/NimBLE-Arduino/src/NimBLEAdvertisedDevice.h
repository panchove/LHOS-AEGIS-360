 ...
 *
 * When we perform a %BLE scan, the result will be a set of devices that are
 * advertising.  This class provides a model of a detected device.
 */
...
private:
  ...
  uint8_t findAdvField(uint8_t type, uint8_t index = 0,
                       size_t *data_loc = nullptr) const;
