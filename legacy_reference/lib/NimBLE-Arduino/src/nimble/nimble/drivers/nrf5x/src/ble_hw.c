 ...
 */
uint8_t ble_hw_whitelist_size(void) { return BLE_HW_WHITE_LIST_SIZE; }
 ...
 * @return int
 */
int ble_hw_whitelist_match(void) { return (int)NRF_RADIO->EVENTS_DEVMATCH; }
 ...
 * @return int
 */
void ble_hw_resolv_list_clear(void) { g_nrf_num_irks = 0; }
 ...
 */
uint8_t ble_hw_resolv_list_size(void) { return BLE_HW_RESOLV_LIST_SIZE; }
