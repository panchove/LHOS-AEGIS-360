 ...
 * @details This structure is used in conjunction with NimBLEUtils::taskWait()
 * and NimBLEUtils::taskRelease(). All items are optional, the m_pHandle will be
 * set in taskWait().
 */
...
/**
 * @brief A BLE Utility class with methods for debugging and general purpose
 * use.
 */
class NimBLEUtils {
public:
