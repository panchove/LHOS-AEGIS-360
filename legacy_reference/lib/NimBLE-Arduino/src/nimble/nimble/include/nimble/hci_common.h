...
#define BLE_HCI_OCF_VS_DUPLICATE_EXCEPTION_LIST                                \
  (MYNEWT_VAL(BLE_HCI_VS_OCF_OFFSET) + (0x0108))
...
#define BLE_HCI_OCF_VS_LEGACY_ADV_CLEAR                                        \
  (MYNEWT_VAL(BLE_HCI_VS_OCF_OFFSET) + (0x010C))
...
#define BLE_HCI_OCF_VS_SET_CHAN_SELECT                                         \
  (MYNEWT_VAL(BLE_HCI_VS_OCF_OFFSET) + (0x0112))

#define BLE_HCI_OCF_VS_SET_EVT_MASK                                            \
  (MYNEWT_VAL(BLE_HCI_VS_OCF_OFFSET) + (0x0116))
