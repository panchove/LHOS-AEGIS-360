...
#define BT_MESH_MBUF_HEADER_SIZE                                               \
  (sizeof(struct os_mbuf_pkthdr) + BT_MESH_ADV_USER_DATA_SIZE +                \
...
struct bt_mesh_adv {
  ...
  uint8_t type : 2, started : 1, busy : 1;
...
static inline void bt_mesh_adv_send_end(int err,
                                        struct bt_mesh_adv const *adv) {
