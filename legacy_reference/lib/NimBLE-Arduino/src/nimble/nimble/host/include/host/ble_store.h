 ...
 * (CSFC). This struct corresponds to the BLE_STORE_OBJ_TYPE_CSFC store object
 * type.
 */
...
#if MYNEWT_VAL(ENC_ADV_DATA)
/**
 * Used as a key for lookups of encrypted advertising data. This struct
 * corresponds to the BLE_STORE_OBJ_TYPE_ENC_ADV_DATA store object type.
 */
