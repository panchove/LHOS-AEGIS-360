...
private:
  ...
  NimBLERemoteCharacteristic(const NimBLERemoteService *pRemoteService,
  ...
  static int descriptorDiscCB(uint16_t connHandle, const ble_gatt_error *error,
                              uint16_t chrHandle, const ble_gatt_dsc *dsc,
                              void *arg);
