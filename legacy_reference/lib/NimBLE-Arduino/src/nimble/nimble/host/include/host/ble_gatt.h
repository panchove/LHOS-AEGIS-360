...
/**
 * @defgroup ble_gatt_register_op_codes Generic Attribute Profile (GATT)
 * Registration Operation Codes
 * @{
 */
...
/**
 * @defgroup ble_gatt_uuid Generic Attribute Profile (GATT) Service and
 * Descriptor UUIDs
 * @{
 */
...
/**
 * @defgroup ble_gatt_chr_properties Generic Attribute Profile (GATT)
...
/** @defgroup ble_gatt_access_op_codes Generic Attribute Profile (GATT) Access
 * Operation Codes
 * @{
 */
...
/**
 * @defgroup ble_gatt_chr_flags Generic Attribute Profile (GATT) Characteristic
 * Flags
 * @{
 */
...
/**
 * @defgroup ble_gatt_service_types Generic Attribute Profile (GATT) Service
 * Types
 * @{
 */
...
#define BLE_GATT_CHR_UNIT_KILOGRAM_PER_CUBIC_METRE_DENSITY                     \
  0x2715 /* Density                                                            \
          */
#define BLE_GATT_CHR_UNIT_KILOGRAM_PER_SQUARE_METRE                            \
  0x2716 /* Surface Density                                                    \
          */
#define BLE_GATT_CHR_UNIT_CUBIC_METRE_PER_KILOGRAM                             \
  0x2717                                                 /* Specific Volume    \
                                                          */
#define BLE_GATT_CHR_UNIT_AMPERE_PER_SQUARE_METRE 0x2718 /* Current Density */
#define BLE_GATT_CHR_UNIT_AMPERE_PER_METRE                                     \
  0x2719 /* Magnetic Field Strength                                            \
          */
#define BLE_GATT_CHR_UNIT_MOLE_PER_CUBIC_METRE                                 \
  0x271A /* Amount Concentration                                               \
          */
#define BLE_GATT_CHR_UNIT_KILOGRAM_PER_CUBIC_METRE_MASS_CONC                   \
  0x271B /* Mass Concentration */
...
#define BLE_GATT_CHR_UNIT_RELATIVE_PERMEABILITY                                \
...
#define BLE_GATT_CHR_UNIT_BECQUEREL                                            \
  0x2732                              /* Activity Referred To A Radionuclide */
...
#define BLE_GATT_CHR_UNIT_RADIAN_PER_SECOND_SQUARED                            \
  0x2744 /* Angular Acceleration */
#define BLE_GATT_CHR_UNIT_WATT_PER_SQUARE_METRE_HEAT                           \
  0x2745                                          /* Heat Flux Density */
#define BLE_GATT_CHR_UNIT_JOULE_PER_KELVIN 0x2746 /* Heat Capacity */
#define BLE_GATT_CHR_UNIT_JOULE_PER_KILOGRAM_KELVIN                            \
  0x2747                                            /* Specific Heat Capacity */
#define BLE_GATT_CHR_UNIT_JOULE_PER_KILOGRAM 0x2748 /* Specific Energy */
#define BLE_GATT_CHR_UNIT_WATT_PER_METRE_KELVIN                                \
  0x2749 /* Thermal Conductivity */
...
#define BLE_GATT_CHR_UNIT_COULOMB_PER_CUBIC_METRE                              \
  0x274C /* Electric Charge Density */
#define BLE_GATT_CHR_UNIT_COULOMB_PER_SQUARE_METRE_CHARGE                      \
  0x274D /* Surface Charge Density */
#define BLE_GATT_CHR_UNIT_COULOMB_PER_SQUARE_METRE_FLUX                        \
  0x274E                                         /* Electric Flux Density */
...
#define BLE_GATT_CHR_UNIT_WATT_PER_SQUARE_METRE_STERADIAN                      \
  0x2756 /* Radiance                                                           \
          */
#define BLE_GATT_CHR_UNIT_KATAL_PER_CUBIC_METRE                                \
  0x2757                                /* Catalytic Activity Concentration */
...
#define BLE_GATT_CHR_UNIT_DEGREE_FAHRENHEIT                                    \
  0x27AC                                    /* Thermodynamic Temperature */
...
#define BLE_GATT_CHR_UNIT_MILLIGRAM_PER_DECILITRE_PER_MINUTE                   \
  0x27C6 /* Mass Density Rate */
#define BLE_GATT_CHR_UNIT_KILOVOLT_AMPERE_HOUR                                 \
  0x27C7                                     /* Electrical Apparent Energy */
...
struct ble_gatt_access_ctxt {
   ...
   * If the value is greater than zero it's an indication of a long attribute
   * read.
   */
  uint16_t offset;
};
...
typedef void (*ble_gatt_svc_foreach_fn)(const struct ble_gatt_svc_def *svc,
                                        uint16_t handle,
                                        uint16_t end_group_handle, void *arg);
