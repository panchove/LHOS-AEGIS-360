...
static int ble_ll_hci_vs_rd_static_addr(uint16_t ocf, const uint8_t *cmdbuf,
...
static int ble_ll_hci_vs_set_tx_power(uint16_t ocf, const uint8_t *cmdbuf,
                                      uint8_t cmdlen, uint8_t *rspbuf,
                                      uint8_t *rsplen) {
...
static int ble_ll_hci_vs_css_configure(uint16_t ocf, const uint8_t *cmdbuf,
                                       uint8_t cmdlen, uint8_t *rspbuf,
                                       uint8_t *rsplen) {
...
static int ble_ll_hci_vs_css_enable(uint16_t ocf, const uint8_t *cmdbuf,
                                    uint8_t cmdlen, uint8_t *rspbuf,
                                    uint8_t *rsplen) {
...
static int ble_ll_hci_vs_css_set_next_slot(uint16_t ocf, const uint8_t *cmdbuf,
                                           uint8_t cmdlen, uint8_t *rspbuf,
                                           uint8_t *rsplen) {
...
static int ble_ll_hci_vs_css_set_conn_slot(uint16_t ocf, const uint8_t *cmdbuf,
                                           uint8_t cmdlen, uint8_t *rspbuf,
                                           uint8_t *rsplen) {
...
static int ble_ll_hci_vs_css_read_conn_slot(uint16_t ocf, const uint8_t *cmdbuf,
                                            uint8_t cmdlen, uint8_t *rspbuf,
                                            uint8_t *rsplen) {
...
static int ble_ll_hci_vs_set_data_len(uint16_t ocf, const uint8_t *cmdbuf,
                                      uint8_t cmdlen, uint8_t *rspbuf,
                                      uint8_t *rsplen) {
  ...
  rc = ble_ll_conn_set_data_len(connsm, tx_octets, tx_time, rx_octets, rx_time);
  if (rc) {
    return rc;
  }
...
static int ble_ll_hci_vs_set_antenna(uint16_t ocf, const uint8_t *cmdbuf,
                                     uint8_t cmdlen, uint8_t *rspbuf,
                                     uint8_t *rsplen) {
...
#if MYNEWT_VAL(BLE_LL_HCI_VS_CONN_STRICT_SCHED)
#if !MYNEWT_VAL(BLE_LL_CONN_STRICT_SCHED_FIXED)
  BLE_LL_HCI_VS_CMD(BLE_HCI_OCF_VS_CSS_CONFIGURE, ble_ll_hci_vs_css_configure),
#endif
  BLE_LL_HCI_VS_CMD(BLE_HCI_OCF_VS_CSS_ENABLE, ble_ll_hci_vs_css_enable),
...
static struct ble_ll_hci_vs_cmd *ble_ll_hci_vs_find_by_ocf(uint16_t ocf) {
