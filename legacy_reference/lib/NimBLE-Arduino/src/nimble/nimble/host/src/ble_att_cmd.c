...
static const void *ble_att_init_parse(uint8_t op, const void *payload,
...
static void *ble_att_init_write(uint8_t op, void *payload, int min_len,
                                int actual_len) {
  uint8_t *u8ptr;
...
void ble_att_error_rsp_parse(const void *payload, int len,
  ...
  src = ble_att_init_parse(BLE_ATT_OP_ERROR_RSP, payload, BLE_ATT_ERROR_RSP_SZ,
                           len);
...
void ble_att_error_rsp_write(void *payload, int len,
  ...
  dst = ble_att_init_write(BLE_ATT_OP_ERROR_RSP, payload, BLE_ATT_ERROR_RSP_SZ,
                           len);
...
void ble_att_mtu_req_parse(const void *payload, int len,
  ...
  src =
    ble_att_init_parse(BLE_ATT_OP_MTU_REQ, payload, BLE_ATT_MTU_CMD_SZ, len);
...
void ble_att_mtu_rsp_parse(const void *payload, int len,
  ...
  src =
    ble_att_init_parse(BLE_ATT_OP_MTU_RSP, payload, BLE_ATT_MTU_CMD_SZ, len);
...
void ble_att_mtu_req_write(void *payload, int len,
  ...
  dst =
    ble_att_init_write(BLE_ATT_OP_MTU_REQ, payload, BLE_ATT_MTU_CMD_SZ, len);
...
void ble_att_mtu_rsp_write(void *payload, int len,
  ...
  dst =
    ble_att_init_write(BLE_ATT_OP_MTU_RSP, payload, BLE_ATT_MTU_CMD_SZ, len);
  dst->bamc_mtu = htole16(src->bamc_mtu);
}
...
void ble_att_find_type_value_req_parse(
  const void *payload, int len, struct ble_att_find_type_value_req *dst) {
...
void ble_att_read_req_parse(const void *payload, int len,
  ...
  src =
    ble_att_init_parse(BLE_ATT_OP_READ_REQ, payload, BLE_ATT_READ_REQ_SZ, len);
...
void ble_att_read_req_write(void *payload, int len,
  ...
  dst =
    ble_att_init_write(BLE_ATT_OP_READ_REQ, payload, BLE_ATT_READ_REQ_SZ, len);
...
void ble_att_read_group_type_req_parse(
  const void *payload, int len, struct ble_att_read_group_type_req *dst) {
...
void ble_att_read_group_type_rsp_parse(
  const void *payload, int len, struct ble_att_read_group_type_rsp *dst) {
...
void ble_att_indicate_rsp_parse(const void *payload, int len) {
  ble_att_init_parse(BLE_ATT_OP_INDICATE_RSP, payload, BLE_ATT_INDICATE_RSP_SZ,
                     len);
}

void ble_att_indicate_rsp_write(void *payload, int len) {
  ble_att_init_write(BLE_ATT_OP_INDICATE_RSP, payload, BLE_ATT_INDICATE_RSP_SZ,
                     len);
}
