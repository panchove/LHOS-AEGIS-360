...
const char *alpn_protos[] = {"h2", "http/1.1",
                             NULL}; // Example list, preferring HTTP/2
// const char *alpn_protos[] = { "mqtt", NULL }; // Example list, preferring
// MQTT const char *alpn_protos[] = { "h2", NULL }; // Example list, preferring
// gRPC const char *alpn_protos[] = { "ssh", NULL }; // Example list, preferring
// SSH const char *alpn_protos[] = { "webrtc", NULL }; // Example list,
// preferring WebRTC
...
// To use this example ensure to obtain a valid root CA certificate and replace
// the content of the ca_cert.h file with the content of the root CA certificate
// in PEM format.
