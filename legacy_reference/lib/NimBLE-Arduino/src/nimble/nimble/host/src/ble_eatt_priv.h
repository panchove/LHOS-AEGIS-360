...
typedef int (*ble_eatt_att_rx_fn)(uint16_t conn_handle, uint16_t cid,
...
#else
static inline void ble_eatt_init(ble_eatt_att_rx_fn att_rx_fn) {}

static inline void ble_eatt_release_chan(uint16_t conn_handle, uint8_t op) {}

static inline uint16_t ble_eatt_get_available_chan_cid(uint16_t conn_handle,
                                                       uint8_t op) {
