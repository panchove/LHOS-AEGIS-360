...
public:
   ...
   * @param [in] pAdv A convenience pointer to the extended advertising
   * interface.
   ...
   * @param [in] pAdv A convenience pointer to the extended advertising
   * interface.
   * @param [in] instId The instance ID of the advertisement that the scan
   * response request was made.
   * @param [in] addr The address of the device making the request.
   */
  virtual void onScanRequest(NimBLEExtAdvertising *pAdv, uint8_t instId,
                             NimBLEAddress addr);
