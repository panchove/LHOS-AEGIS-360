...
static inline int stats_init(void *a, uint8_t b, uint8_t c, void *d,
                             uint8_t e) {
  /* dummy */
  return 0;
}
...
static inline int stats_init_and_reg(void *a, uint8_t b, uint8_t c, void *d,
                                     uint8_t e, const char *f) {
  /* dummy */
  return 0;
}
