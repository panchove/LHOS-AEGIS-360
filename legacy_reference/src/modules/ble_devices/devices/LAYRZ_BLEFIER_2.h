...
#ifndef LAYRZ_BLEFIER_2_DEVICES_LAYRZHUB_H
#define LAYRZ_BLEFIER_2_DEVICES_LAYRZHUB_H

#include <modules/ble_devices/BleSensorData.h>
#include <modules/utilities/UtilitiesLayrzHub.h>

class LAYRZ_BLEFIER_2_decoder {
public:
...
#endif // LAYRZ_BLEFIER_2_DEVICES_LAYRZHUB_H